...
// Anyone else with the ability to get a Point object is able to modify it, provided they modify x and y together.
public class DelegatingTracker {
	...
	//is a Point object mutable? Yes its is mutable.
	class Point {
		private int x, y;
