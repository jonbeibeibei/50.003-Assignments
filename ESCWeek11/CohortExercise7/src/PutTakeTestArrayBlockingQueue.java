 ...
 */
public class PutTakeTestArrayBlockingQueue {
    ...
    public static void main(String[] args) throws Exception {
        new PutTakeTestBoundedBuffer(10, 10, 100000).test(); // sample parameters
        pool.shutdown();
    }

    public PutTakeTestArrayBlockingQueue(int capacity, int npairs, int ntrials) {
